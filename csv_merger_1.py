...
def move(fp, type):
    for root, dirs, files in os.walk(fp):
        for dir in dirs:
            if dir not in ['国梓洋_OD', '国梓洋_OS', '焦雨彤_OD', '焦雨彤_OS', '牛梓恒_OD', '牛梓恒_OS', '田芯畅_OS', '周子俊_OD', '周子俊_OS', '牛梓轩_OD', '牛梓轩_OS', '国梓洋_OD', '国梓洋_OS', '焦雨彤_OD', '焦雨彤_OS', '牛梓恒_OD', '牛梓恒_OS']:
                continue
            print(dir)
...
path = r"F:\EYES\CSVs({})\octa_processed".format(TYPE)
move(path, TYPE)
